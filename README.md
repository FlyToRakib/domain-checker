...
* **Dynamic TLD Aggregator:** Automatically handles `.com`, `.net`, `.ai`, `.io`, and more via a sanitized input system.
* **Persistence:** Background service worker ensures the engine never sleeps or crashes when switching windows.
* **Data Export:** One-click JSON export for all verified available domains.
